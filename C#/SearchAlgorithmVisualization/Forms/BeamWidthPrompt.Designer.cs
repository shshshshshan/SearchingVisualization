namespace SearchAlgorithmVisualization.Forms
{
    partial class BeamWidthPrompt
    {
        ...
        private void InitializeComponent()
        {
            ...
            PromptLabel.Size = new Size(182, 22);
            PromptLabel.TabIndex = 1;
            PromptLabel.Text = "Enter Beam Width:";
            // 
            // CancelPromptButton
            // 
            CancelPromptButton.Cursor = Cursors.Hand;
            CancelPromptButton.Location = new Point(200, 61);
            ...
            EnterPromptButton.Location = new Point(313, 61);
            ...
            CustomValueTextbox.Location = new Point(200, 29);
            ...
            MaximizeBox = false;
            MinimizeBox = false;
            Name = "BeamWidthPrompt";
            Text = "BeamWidthPrompt";
            Deactivate += BeamWidthPrompt_Deactivate;
            ResumeLayout(false);
            PerformLayout();
        }
